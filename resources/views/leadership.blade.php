...
<body class="home page-template-default page page-id-7 woocommerce-js wpb-js-composer js-comp-ver-5.6 vc_responsive">
	<div id="page">
		...
		<div id="page-title" class="page-title" >
			...
			<div class="container">
				<div class="row">
					<div id="page-title-text" class="page-title-text col-xs-12 col-sm-12 col-md-12 col-lg-12"><h1>LEADERSHIP</h1></div>
					<div id="breadcrumb-text" class="breadcrumb-text col-xs-12 col-sm-12 col-md-12 col-lg-12"><ul class="breadcrumbs"><li><a href="{{route('home')}}">Home</a></li><li>LEADERSHIP</li></ul></div>
                ...
                <div class="wpb_column vc_column_container vc_col-sm-12">
                    <div class="vc_column-inner">
                        <div class="wpb_wrapper">
                            ...
                            @foreach($leaders as $b)
                            	<div class="vc_row wpb_row vc_inner vc_row-fluid" style="margin-top:15px;margin-bottom: 15px;">
                                            ...
                                            <div class="wpb_single_image wpb_content_element vc_align_left">
                                                <figure class="wpb_wrapper vc_figure">
                                                    <div class="vc_single_image-wrapper vc_box_border_grey">
                                                        <img width="200" height="200" src="{{\Storage::disk('public')->url('app/public/users/'.$b->image)}}" class="vc_single_image-img attachment-full" alt="" />
                                                    </div>
                                                </figure>
                                            </div>
                                        </div>
