...
<div id="page">
		...
		<div id="page-title" class="page-title" >
			...
			<div class="container">
				<div class="row">
					<div id="page-title-text" class="page-title-text col-xs-12 col-sm-12 col-md-12 col-lg-12"><h1>By Laws</h1></div>
					<div id="breadcrumb-text" class="breadcrumb-text col-xs-12 col-sm-12 col-md-12 col-lg-12"><ul class="breadcrumbs"><li><a href="https://isoc.pk">Home</a></li><li>ByLaws</li></ul></div>
